...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--resume_step", type=int, default=None, help="Step to resume training from. If not set, inferred from checkpoint filename (e.g. step-1500.safetensors -> 1500).")
    return parser
